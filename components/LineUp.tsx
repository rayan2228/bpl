...
const LineUp = () => {
    return (
        <section className='bg-primary-color-four pt-[78px] pb-[138px] text-center'>
            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                    {players.map((p, i) => (
                        <div key={i} className="p-0.5 rounded-2xl bg-linear-to-br from-[#00071D] to-[#F7C848] h-full">
                            ...
                            <div className="bg-primary-color-four text-white text-left relative rounded-2xl p-4 h-full flex flex-col">
                                ...
                                <div className="relative min-h-[200px] w-full flex justify-center">
                                    <Image src={p.img} alt={p.name} className="object-contain" />
                                    <Image src={p.icon} alt={p.role} className='absolute -top-10 left-4' />
                                </div>
